...
class BlogAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        [
            'General Information',
            {'classes': ['wide'], 'fields': ['id', 'author', 'number_of_views']},
        ],
        [
            'Blog Summary',
            {
        ...
        [
            'First Section',
            {
                ...
                'fields': [
                    ...
                    ('first_section_video_link', 'first_section_video_description'),
                    'first_section_list_title_one',
                    'first_section_list_desc_one',
                    'first_section_list_title_two',
                    'first_section_list_desc_two',
                    'first_section_list_title_three',
                    'first_section_list_desc_three',
                    'first_section_list_title_four',
                    'first_section_list_desc_four',
                    'first_section_list_title_five',
                    'first_section_list_desc_five',
                    'first_section_list_title_six',
                    'first_section_list_desc_six',
                    'first_section_references',
                ],
            },
        ],
        [
        ...
        [
            'Third Section',
            {
                ...
                'fields': [
                    ...
                    ('third_section_video_link', 'third_section_video_description'),
        ...
        [
            'Fifth Section',
            {
                ...
                'fields': [
                    ...
                    ('fifth_section_video_link', 'fifth_section_video_description'),
