...
class NewsletterAdmin(admin.ModelAdmin):
    ...
    list_display_links = ['id', 'email', 'timestamp']
...
class SendUserEmailsAdmin(admin.ModelAdmin):
    ...
    list_display_links = ['id', 'subject', 'group', 'timestamp']
    list_filter = ['group']
...
class ReminderEmailsAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        ...
        'display_image_1_text', 'display_image_2_text', 'display_image_3_text', 'display_image_4_text',
    ...
    fieldsets = [
        ...
        [
            'Image Details',
            {
                'classes': ['collapse', 'wide'],
                'fields': [
                    'image_section_heading', 'display_image_1', 'display_image_1_text', 'display_image_2',
                    'display_image_2_text', 'display_image_3', 'display_image_3_text', 'display_image_4',
                    'display_image_4_text'
                ],
            },
        ],
        [
