    ...
    if (
        ...
        if created:
            ...
            if instance.application_status == 'Selected':
                ...
                email_message = f'Hi {instance.first_name}, \n\n\
                    Thank you for your interest in attending the UJ Blockchain Demo Day. \
                    Unfortunately, you were not selected for the Demo Day event. \
                    ...
                    better perspective on Blockchain and 4IR; yes, \
                    we do. Other events will be coming up; sign up for our newsletter to ensure \
