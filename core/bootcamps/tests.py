...
class BootcampTest(TestCase):
    ...
    def test_bootcamp_model(self):
        ...
        max_length = BootcampSignup._meta.get_field('first_name').max_length
...
class BootcampFormTestClass(TestCase):
    ...
    def test_bootcamp_post_form(self):
        ...
        self.assertEqual(response.request.get('CONTENT_TYPE'), 'multipart/form-data; boundary=BoUnDaRyStRiNg')
