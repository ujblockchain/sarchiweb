...
JAZZMIN_SETTINGS = {  # type: ignore
    ...
    'icons': {
        ...
        'bootcamps.bootcampconfig': 'fas fa-sliders-h',
        'bootcamps.BootcampSignup': 'fas fa-campground',
        ...
        'masterclass.masterclassconfig': 'fas fa-chalkboard',
        ...
        'program.projectbuild': 'fas fa-project-diagram',
        'program.ProgramSignUp': 'fas fa-signal',
        'program.programconfig': 'fas fa-cogs',
