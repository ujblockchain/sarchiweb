from core.project.settings import ADMIN_PATH, ENV
...
CSP_SCRIPT_SRC = (
    "'self'", 'https://google.com', 'https://www.googletagmanager.com', 'https://gstatic.com',
    'https://ajax.googleapis.com', 'https://www.google.com', 'https://www.gstatic.com', "'unsafe-inline'"
)
CSP_FONT_SRC = ("'self'", 'https://fonts.gstatic.com', 'https://use.fontawesome.com')
CSP_STYLE_SRC = (
    "'self'", 'https://google.com', 'https://www.googletagmanager.com', 'https://gstatic.com',
    'https://fonts.googleapis.com', 'https://use.fontawesome.com', "'unsafe-inline'"
)
