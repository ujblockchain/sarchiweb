...
class CustomCSPMiddleware:
    ...
    def __call__(self, request):
        ...
        if isinstance(response, HttpResponseServerError) or isinstance(response, HttpResponseNotFound) or isinstance(
           ...
           response['Content-Security-Policy'] = "default-src 'self'; img-src 'self'; style-src 'self' 'unsafe-inline'; script-src 'self' https://www.google.com https://www.googletagmanager.com https://www.gstatic.com; font-src 'self' https://fonts.gstatic.com https://use.fontawesome.com https://fonts.googleapis.com/ 'unsafe-inline';"
